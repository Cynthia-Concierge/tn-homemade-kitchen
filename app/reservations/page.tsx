    ...
    <>
      ...
      <section className="bg-gradient-to-br from-red-900 via-red-800 to-red-900 text-cream py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="font-serif text-4xl md:text-5xl font-bold mb-4">Reservations</h1>
      ...
      {/* Notice */}
      <div className="bg-gold/10 border-b border-gold/20 py-4 px-4 text-center">
        <p className="text-sm text-charcoal-light max-w-2xl mx-auto">
          <span className="font-semibold text-gold-dark">Important:</span> Our retail location is currently undergoing renovations.
          Reservations will resume once renovations are complete. In the meantime, we are fully open for{" "}
          <a href="/catering" className="text-gold-dark underline hover:text-gold font-semibold">catering orders</a>,{" "}
          <a href="/food-truck" className="text-gold-dark underline hover:text-gold font-semibold">food truck bookings</a>, and tray orders.
          Call <a href="tel:2677670073" className="text-gold-dark underline hover:text-gold font-semibold">267-767-0073</a> for details.
        </p>
      </div>
          ...
          <form className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-cream-dark space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  type="text"
                  required
                  className="w-full px-4 py-3 rounded-xl border border-cream-dark focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-all"
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <label className="relative cursor-pointer">
                  ...
                  <div className="p-4 rounded-xl border-2 border-cream-dark peer-checked:border-gold peer-checked:bg-gold/5 text-center transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <select
                  id="r-guests"
                  required
                  className="w-full px-4 py-3 rounded-xl border border-cream-dark focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-all bg-white"
                >
            ...
            <div>
              ...
              <textarea
                id="r-message"
                rows={3}
                className="w-full px-4 py-3 rounded-xl border border-cream-dark focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-all resize-y"
            ...
            <div className="bg-cream rounded-xl p-4 text-center">
              <p className="text-xs text-charcoal-light/70">
                <span className="font-semibold">Please Note:</span> Please arrive promptly at your reserved time.
