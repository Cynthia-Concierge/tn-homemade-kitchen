        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-red-800/10 text-red-800 rounded-xl flex items-center justify-center shrink-0">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      <a href="tel:2154621095" className="block text-charcoal-light/70 hover:text-gold transition-colors">
                        <span className="font-medium text-charcoal">Restaurant:</span> 215-462-1095
                      </a>
                      <a href="tel:2677670073" className="block text-charcoal-light/70 hover:text-gold transition-colors">
                        <span className="font-medium text-charcoal">Catering (Michael):</span> 267-767-0073
                      </a>
                      <p className="text-charcoal-light/50">
                        <span className="font-medium text-charcoal-light/70">Fax:</span> 215-462-7090
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:michael@tnhomemadekitchen.com" className="text-charcoal-light/70 hover:text-gold transition-colors">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-charcoal-light/70 space-y-0.5">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-charcoal-light/70 hover:text-gold transition-colors"
                    >
            ...
            <div>
              ...
              <form className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-cream-dark space-y-5">
